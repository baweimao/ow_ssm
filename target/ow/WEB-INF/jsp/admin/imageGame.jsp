...
<div class="div">
	...
	<div class="panel panel-warning editDiv">
		<div class="panel-heading">修改图片(图片尺寸400*340)</div>
		<div class="panel-body">
			<form method="post" id="editForm" action="admin_game_imageupdate" enctype="multipart/form-data">
				<table class="editTable">
					<tr>
						<td class="name">原图</td>
						<td><img height="80px" src="/img/gameLogo/${g.id}.jpg"></td>
					</tr>
					<tr>
						<td class="name">新图</td>

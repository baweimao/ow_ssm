...
<div class="div">
	<ul class="breadcrumb">
		...
		<li><a href="admin_people_list?tid=${p.tid}">人物</a></li>
		<li><a href="#">修改图片</a></li>
	</ul>
	<div class="panel panel-warning editDiv">
		<div class="panel-heading">修改图片(图片尺寸120*120)</div>
		<div class="panel-body">
			<form method="post" id="editForm" action="admin_people_imageupdate" enctype="multipart/form-data">
				<table class="editTable">
					<tr>
						<td class="name">原图</td>
						<td><img height="80px" src="/img/peopleLogo/${p.id}.jpg"></td>
					</tr>
					<tr>
						<td class="name">新图</td>
